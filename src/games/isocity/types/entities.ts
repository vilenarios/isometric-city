// IsoCity entity type definitions
// These are city-builder specific entities: vehicles, pedestrians, effects
// A different game (like an RTS) would have different entity types

import { CardinalDirection, Particle, PhysicsParticle, DirectionMeta as CoreDirectionMeta } from '@/core/types';

// ============================================================================
// Direction Types (re-export from core for convenience)
// ============================================================================

// Alias for backward compatibility - matches existing code that uses CarDirection
export type CarDirection = CardinalDirection;

// Re-export DirectionMeta from core (same structure, single source of truth)
export type DirectionMeta = CoreDirectionMeta;
...
export type ContrailParticle = Particle;
...
export type RotorWashParticle = Particle;
...
export type WakeParticle = Particle;
...
export type TrainSmokeParticle = PhysicsParticle;
...
export type SmogParticle = PhysicsParticle;
